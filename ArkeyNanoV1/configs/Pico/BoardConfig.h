...
#define PIN_DPAD_RIGHT  14           // RIGHT
#define PIN_DPAD_LEFT   11           // LEFT
#define PIN_BUTTON_B1   15           // B1 / A / B / Cross / 2 / K1
#define PIN_BUTTON_B2   18           // B2 / B / A / Circle / 3 / K2
#define PIN_BUTTON_R2   20           // R2 / RT / ZR / R2 / 8 / K3
#define PIN_BUTTON_L2   22           // L2 / LT / ZL / L2 / 7 / K4
#define PIN_BUTTON_B3   16          // B3 / X / Y / Square / 1 / P1
