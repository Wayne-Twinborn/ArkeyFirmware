...
#define PIN_DPAD_LEFT   10           // LEFT
#define PIN_BUTTON_B1   14           // B1 / A / B / Cross / 2 / K1
#define PIN_BUTTON_B2   16           // B2 / B / A / Circle / 3 / K2
#define PIN_BUTTON_R2   18           // R2 / RT / ZR / R2 / 8 / K3
#define PIN_BUTTON_L2   21           // L2 / LT / ZL / L2 / 7 / K4
...
#define PIN_BUTTON_A1   28          // A1 / Guide / Home / PS / 13 / ~
#define PIN_BUTTON_A2   22          // A2 / ~ / Capture / ~ / 14 / ~
